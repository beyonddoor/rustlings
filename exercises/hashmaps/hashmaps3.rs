...
fn build_scores_table(results: String) -> HashMap<String, Team> {
    ...
    for r in results.lines() {
        ...
        let newTeam = match scores.get(&team_1_name) {
            None => Team {
        ...
        scores.insert(team_1_name, newTeam);

        let team1 = scores.get(&team_2_name);
        let newTeam = match team1 {
            None => Team {
        ...
        scores.insert(team_2_name, newTeam);
    }
    scores
}
